...
const Page = () => {
  ...
  const handleAccept = () => {
    ...
    verifyPayment.mutate({ registrationId: selectedReg.id }, {
      onSuccess: (e) => {
        setRejectionBox("");
        setSelectedReg(null);
        utils.registration.getUnverifiedRegistrations.setData(CurrentUser?.clerkId ?? "", prevReg => {
  ...
  const handleReject = () => {
    if (!selectedReg) return;
    rejectPayment.mutate({ registrationId: selectedReg.id, reason: rejectionBox }, {
      onSuccess: (e) => {
        setRejectionBox("");
        setSelectedReg(null);
        utils.registration.getUnverifiedRegistrations.setData(CurrentUser?.clerkId ?? "", prevReg => {
              ...
              >
                <div className="details-container w-full pl-4">
                  ...
                  <div className="flex items-center gap-4 mt-4">
                    ...
                    <button
                      className="reject-button bg-red-500 px-4 py-2 disabled:bg-red-100 text-white"
