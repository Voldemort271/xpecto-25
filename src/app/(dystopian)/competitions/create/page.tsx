...
import { type CompetitionType } from "@/app/types";
import {
...
const Page = () => {
  ...
  const competitionLevelData = [
    {
      name: "Round-1",
      description: "Round-1 is very important",
      venue: "college room-1",
      timeline: "10/01/2025",
    },
    {
      name: "Round-2",
      description: "Round-2 is logical",
      venue: "college room-2",
      timeline: "10/02/2025",
    },
    {
      name: "Round-3",
      description: "Round-3 is final round",
      venue: "Other place",
      timeline: "10/03/2025",
    },
    ...
    <>
      ...
      {selectedTab == 2 && (
        <div style={{ padding: "1rem" }}>
          <MultiEntity
            entityData={competitionLevelData}
