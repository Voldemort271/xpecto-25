...
import {CompetitionType, ProniteType} from "../../../types"
  ...
  return (
    <>
      ...
      <div className="flex flex-row">
        ...
        <button className="btn" style={{marginLeft:"1rem",marginTop:"1rem"}} onClick={()=>{window.location.href="/pronite"}}>Cancel</button>
        </div>
      </div>
    </>
  );
