...
import { $Enums, Merch, type RegistrationLevel } from "@prisma/client";
...
const MerchPlanCard = ({ data }: { data: Merch }) => {
  ...
  const handleSizeChange = (event) => {
    setSelectedSize(event.target.value); // Store selected size
  };
  ...
  return (
    ...
    >
      ...
      <div>
        <img src={data.image} style={{ width: "30rem" }} />
      </div>
