...
const ExposDetailsView = ({ data }: Props) => {
  ...
  return (
    <div className="z-0 flex h-full w-full flex-col items-start justify-start bg-neutral-900 p-5 md:p-12">
      <Image
        ...
        width={1920}
        height={1080}
        alt={data?.exposDetails.name ?? "Background image"}
      ...
      <div className="py-5">
        ...
        >
          <Link
            href={`/expos/${data?.exposDetails.slug}`}
...
export default ExposDetailsView;
